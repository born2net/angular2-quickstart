System.register(['./linker/directive_resolver', './linker/compiler', './linker/view_manager', './linker/query_list', './linker/dynamic_component_loader', './linker/element_ref', './linker/template_ref', './linker/view_ref', './linker/view_container_ref'], function(exports_1) {
    return {
        setters:[
