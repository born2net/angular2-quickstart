System.register(['angular2/src/core/facade/lang', 'angular2/src/core/facade/exceptions', 'angular2/src/core/facade/collection', 'angular2/src/core/reflection/reflection', './key', './metadata', './exceptions', './forward_ref'], function(exports_1) {
    ...
    function _dependenciesFor(typeOrFunc) {
        ...
        if (lang_1.isBlank(params))
            return [];
        if (collection_1.ListWrapper.any(params, (p) => lang_1.isBlank(p))) {
    ...
    return {
        ...
        execute: function() {
            ...
            const _EMPTY_LIST = lang_1.CONST_EXPR([]);
            /**
             ...
             * @deprecated
             */
            let Binding = class extends Provider {
            ...
            ResolvedProvider_ = ResolvedProvider_;
            /**
