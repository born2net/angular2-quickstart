System.register(['angular2/angular2', 'angular2/src/core/facade/lang', './headers', './enums'], function(exports_1) {
    ...
    var angular2_1, lang_1, headers_1, enums_1;
    ...
    return {
        ...
        execute: function() {
             ...
             * ```
             */
            let BaseResponseOptions = class extends ResponseOptions {
                constructor() {
                    super({ status: 200, statusText: 'Ok', type: enums_1.ResponseTypes.Default, headers: new headers_1.Headers() });
                }
            };
