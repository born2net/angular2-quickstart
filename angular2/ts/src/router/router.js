System.register(['angular2/src/core/facade/async', 'angular2/src/core/facade/collection', 'angular2/src/core/facade/lang', 'angular2/src/core/facade/exceptions', './instruction', './route_lifecycle_reflector'], function(exports_1) {
    var async_1, collection_1, lang_1, exceptions_1, instruction_1, route_lifecycle_reflector_1;
    var _resolveToTrue, _resolveToFalse, Router, RootRouter, ChildRouter, SLASH;
    function splitAndFlattenLinkParams(linkParams) {
        return collection_1.ListWrapper.reduce(linkParams, (accumulation, item) => {
    ...
    return {
        ...
        execute: function() {
            ...
            let _resolveToFalse = async_1.PromiseWrapper.resolve(false);
            /**
            ...
            class Router {
                        ...
                        return this._canDeactivate(instruction)
                            ...
                            if (result) {
                                return this.commit(instruction, _skipLocationChange)
                                    .then((_) => {
                                    this._emitNavigationFinish(instruction_1.stringifyInstruction(instruction));
                                    return true;
                                });
                            }
                        });
                ...
                _settleInstruction(instruction) {
                    ...
                    collection_1.StringMapWrapper.forEach(instruction.auxInstruction, (instruction, _) => {
                        unsettledInstructions.push(this._settleInstruction(instruction));
                    });
                    return async_1.PromiseWrapper.all(unsettledInstructions);
                }
                _emitNavigationFinish(url) { async_1.ObservableWrapper.callNext(this._subject, url); }
                _afterPromiseFinishNavigating(promise) {
                    return async_1.PromiseWrapper.catchError(promise.then((_) => this._finishNavigating()), (err) => {
                ...
                _canReuse(instruction) {
                    ...
                    return this._outlet.canReuse(instruction.component)
                        ...
                        if (result && lang_1.isPresent(this._childRouter) && lang_1.isPresent(instruction.child)) {
                ...
                commit(instruction, _skipLocationChange = false) {
                    ...
                    return next.then((_) => async_1.PromiseWrapper.all(promises));
                }
                /** @internal */
                ...
                generate(linkParams) {
                    ...
                    if (rest.length < 1) {
                        let msg = `Link "${collection_1.ListWrapper.toJSON(linkParams)}" must include a route name.`;
            ...
            class RootRouter extends Router {
                constructor(registry, location, primaryComponent) {
                    ...
                    this._location.subscribe((change) => this.navigateByUrl(change['url'], lang_1.isPresent(change['pop'])));
