System.register(['angular2/src/core/facade/collection', 'angular2/src/core/facade/exceptions', 'angular2/src/core/facade/lang'], function(exports_1) {
    var collection_1, exceptions_1, lang_1;
    var RouteParams, Instruction, PrimaryInstruction, ComponentInstruction, ComponentInstruction_;
    ...
    exports_1("stringifyInstruction", stringifyInstruction);
    ...
    exports_1("stringifyInstructionPath", stringifyInstructionPath);
    ...
    exports_1("stringifyInstructionQuery", stringifyInstructionQuery);
    ...
    function stringifyAux(instruction) {
        var routes = [];
        collection_1.StringMapWrapper.forEach(instruction.auxInstruction, (auxInstruction, _) => {
    ...
    return {
        ...
        execute: function() {
            ...
            class ComponentInstruction {
                 ...
                 */
                get specificity() { return exceptions_1.unimplemented(); }
                ;
                /**
                 * Returns `true` if the component type of this instruction has no child {@link RouteConfig},
                 * or `false` if it does.
                 */
                get terminal() { return exceptions_1.unimplemented(); }
                ;
            }
            ...
            ComponentInstruction_ = ComponentInstruction_;
        }
    }
});
