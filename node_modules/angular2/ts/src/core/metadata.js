...
System.register(['./metadata/di', './metadata/directives', './metadata/view', './util/decorators'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
             ...
             *
             */
            Component = decorators_1.makeDecorator(directives_1.ComponentMetadata, (fn) => fn.View = View);
             ...
             */
            Directive = decorators_1.makeDecorator(directives_1.DirectiveMetadata);
             ...
             * ```
             */
            View = decorators_1.makeDecorator(view_1.ViewMetadata, (fn) => fn.View = View);
             ...
             * ```
             */
            Attribute = decorators_1.makeParamDecorator(di_1.AttributeMetadata);
             ...
             */
            Query = decorators_1.makeParamDecorator(di_1.QueryMetadata);
             ...
             * ```
             */
            ContentChildren = decorators_1.makePropDecorator(di_1.ContentChildrenMetadata);
             ...
             * ```
             */
            ContentChild = decorators_1.makePropDecorator(di_1.ContentChildMetadata);
             ...
             * ```
             */
            ViewChildren = decorators_1.makePropDecorator(di_1.ViewChildrenMetadata);
             ...
             * ```
             */
            ViewChild = decorators_1.makePropDecorator(di_1.ViewChildMetadata);
             ...
             * See {@link QueryList} for more details.
             */
            ViewQuery = decorators_1.makeParamDecorator(di_1.ViewQueryMetadata);
             ...
             * ```
             */
            Pipe = decorators_1.makeDecorator(directives_1.PipeMetadata);
             ...
             * ```
             */
            Input = decorators_1.makePropDecorator(directives_1.InputMetadata);
             ...
             * ```
             */
            Output = decorators_1.makePropDecorator(directives_1.OutputMetadata);
             ...
             * ```
             */
            HostBinding = decorators_1.makePropDecorator(directives_1.HostBindingMetadata);
             ...
             * ```
             */
            HostListener = decorators_1.makePropDecorator(directives_1.HostListenerMetadata);
        }
    }
});
