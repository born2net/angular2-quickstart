...
import { Injector, Inject, Injectable, forwardRef } from 'angular2/src/core/di';
...
class AppViewManager {
    constructor() {
         ...
         */
        this.abstract = getViewContainer(location, ElementRef);
        /**
         ...
         */
        this.abstract = getNamedElementInComponentView(hostLocation, ElementRef, variableName, string);
        /**
         * Returns the component instance for the provided Host Element.
         */
        this.abstract = getComponent(hostLocation, ElementRef);
        /**
         ...
         * ```
         */
        this.abstract = createRootHostView(hostProtoViewRef, ProtoViewRef, overrideSelector, string, injector, Injector);
        /**
         ...
         * destroyed as well.
         */
        this.abstract = destroyRootHostView(hostViewRef, HostViewRef);
        /**
        ...
        this.abstract = createEmbeddedViewInContainer(viewContainerLocation, ElementRef, index, number, templateRef, TemplateRef);
        /**
         ...
         */
        this.abstract = createHostViewInContainer(viewContainerLocation, ElementRef, index, number, protoViewRef, ProtoViewRef, imperativelyCreatedInjector, ResolvedProvider[]);
        /**
         ...
         */
        this.abstract = destroyViewInContainer(viewContainerLocation, ElementRef, index, number);
        /**
         *
         * See {@link AppViewManager#detachViewInContainer}.
         */
        // TODO(i): refactor detachViewInContainer+attachViewInContainer to moveViewInContainer
        this.abstract = attachViewInContainer(viewContainerLocation, ElementRef, index, number, viewRef, ViewRef);
        /**
         * See {@link AppViewManager#attachViewInContainer}.
         */
        this.abstract = detachViewInContainer(viewContainerLocation, ElementRef, index, number);
    }
    /**
