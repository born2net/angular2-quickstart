System.register(['angular2/src/core/facade/lang', 'angular2/src/core/facade/exceptions', 'angular2/src/core/facade/collection', './parser/ast', './change_detection_util', './dynamic_change_detector', './directive_record', './event_binding', './coalesce', './proto_record'], function(exports_1) {
    ...
    function createPropertyRecords(definition) {
        ...
        collection_1.ListWrapper.forEachWithIndex(definition.bindingRecords, (b, index) => recordBuilder.add(b, definition.variableNames, index));
    ...
    function _mapPrimitiveName(keys) {
        var stringifiedKeys = keys.map(k => lang_1.isString(k) ? `"${k}"` : `${k}`).join(', ');
    ...
    return {
        ...
        execute: function() {
            class DynamicProtoChangeDetector {
            ...
            ProtoRecordBuilder = ProtoRecordBuilder;
            class _ConvertAstIntoProtoRecords {
                ...
                visitIf(ast) { throw new exceptions_1.BaseException('Not supported'); }
                _visitAll(asts) {
