System.register(['./differs/iterable_differs', './differs/default_iterable_differ', './differs/keyvalue_differs', './differs/default_keyvalue_differ', 'angular2/src/core/facade/lang', './parser/ast', './parser/lexer', './parser/parser', './parser/locals', './exceptions', './interfaces', './constants', './proto_change_detector', './jit_proto_change_detector', './binding_record', './directive_record', './dynamic_change_detector', './change_detector_ref', './change_detection_util'], function(exports_1) {
    ...
    return {
        setters:[
            ...
            function (constants_1_1) {
                exports_1({
                    ...
                    "CHANGE_DECTION_STRATEGY_VALUES": constants_1_1["CHANGE_DECTION_STRATEGY_VALUES"]
                });
            },
        ...
        execute: function() {
             ...
             */
            keyValDiff = lang_1.CONST_EXPR([lang_1.CONST_EXPR(new default_keyvalue_differ_1.DefaultKeyValueDifferFactory())]);
            /**
             * Structural diffing for `Iterable` types such as `Array`s.
             */
            iterableDiff = lang_1.CONST_EXPR([lang_1.CONST_EXPR(new default_iterable_differ_1.DefaultIterableDifferFactory())]);
            defaultIterableDiffers = lang_1.CONST_EXPR(new iterable_differs_1.IterableDiffers(iterableDiff));
            defaultKeyValueDiffers = lang_1.CONST_EXPR(new keyvalue_differs_1.KeyValueDiffers(keyValDiff));
        }
    }
});
