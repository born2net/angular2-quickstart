...
class Renderer {
    constructor() {
         ...
         */
        this.abstract = registerComponentTemplate(templateId, number, commands, RenderTemplateCmd[], styles, string[], nativeShadow, boolean);
        /**
         * Creates a {@link RenderProtoViewRef} from an array of {@link RenderTemplateCmd}`s.
         */
        this.abstract = createProtoView(cmds, RenderTemplateCmd[]);
        /**
         ...
         */
        this.abstract = createRootHostView(hostProtoViewRef, RenderProtoViewRef, fragmentCount, number, hostElementSelector, string);
        /**
         ...
         * Returns an instance of {@link RenderViewWithFragments}, representing the Render View.
         */
        this.abstract = createView(protoViewRef, RenderProtoViewRef, fragmentCount, number);
        /**
         ...
         */
        this.abstract = destroyView(viewRef, RenderViewRef);
        /**
         * Attaches the Nodes of a Render Fragment after the last Node of `previousFragmentRef`.
         */
        this.abstract = attachFragmentAfterFragment(previousFragmentRef, RenderFragmentRef, fragmentRef, RenderFragmentRef);
        /**
         * Attaches the Nodes of the Render Fragment after an Element.
         */
        this.abstract = attachFragmentAfterElement(elementRef, RenderElementRef, fragmentRef, RenderFragmentRef);
        /**
         ...
         */
        this.abstract = detachFragment(fragmentRef, RenderFragmentRef);
        /**
         ...
         */
        this.abstract = hydrateView(viewRef, RenderViewRef);
        /**
         ...
         */
        this.abstract = dehydrateView(viewRef, RenderViewRef);
        /**
         ...
         * </div>
         */
        this.abstract = getNativeElementSync(location, RenderElementRef);
        /**
         * Sets a property on the Element specified via `location`.
         */
        this.abstract = setElementProperty(location, RenderElementRef, propertyName, string, propertyValue, any);
        /**
         * Sets an attribute on the Element specified via `location`.
         *
         * If `attributeValue` is `null`, the attribute is removed.
         */
        this.abstract = setElementAttribute(location, RenderElementRef, attributeName, string, attributeValue, string);
        /**
         * Sets a (CSS) class on the Element specified via `location`.
         *
         * `isAdd` specifies if the class should be added or removed.
         */
        this.abstract = setElementClass(location, RenderElementRef, className, string, isAdd, boolean);
        /**
         * Sets a (CSS) inline style on the Element specified via `location`.
         *
         * If `styleValue` is `null`, the style is removed.
         */
        this.abstract = setElementStyle(location, RenderElementRef, styleName, string, styleValue, string);
        /**
         * Calls a method on the Element specified via `location`.
         */
        this.abstract = invokeElementMethod(location, RenderElementRef, methodName, string, args, any[]);
        /**
         ...
         * View.
         */
        this.abstract = setText(viewRef, RenderViewRef, textNodeIndex, number, text, string);
        /**
         ...
         */
        this.abstract = setEventDispatcher(viewRef, RenderViewRef, dispatcher, RenderEventDispatcher);
    }
}
